class No {
    ...
    private static void printUpperDiamond(int num, int row) {
        if (row > num) return;
        printSpaces(num - row);
        printStars(2 * row - 1);
        System.out.println();
    ...
    private static void printLowerDiamond(int row, int num) {
        if (row == 0) return;
        printSpaces(num - row);
        printStars(2 * row - 1);
        System.out.println();
    ...
    private static void printVerticalPlus(int size, int row) {
        if (row > size) return;
        printSpaces(2);
        System.out.println("+");
    ...
    private static void printRightAlignedTriangle(int row, int size) {
        if (row >= size) return;
    ...
    private static void printCenteredHorizontalLine(int size) {
    ...
    private static void printInvertedSlashTriangle(int row, int size) {
        if (row > size) return;
        printSpaces(row);
    ...
    private static void printSlashes(int count) {
        if (count == 0) return;
        System.out.print("/");
